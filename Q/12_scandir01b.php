...
function leseVZ(string $vz):void {
	...
	foreach($inhalt as $d) {
		if($d!="." && $d!="..") {
			if(is_dir($vz . $d)) {
				...
				// ---- REKURSION! ----
				leseVZ($vz . $d . "/"); //Aufruf der Funktion, in der wir uns gerade befinden: "Funktion, die sich selbst (mit geänderten Übergabewerten) aufruft
				// --------------------
...
<html lang="de">
	...
	<body>
		...
		<?php
		leseVZ("../../"); //Aufruf der Funktion leseVZ zum Auslesen und Ausgeben des Verzeichnisinhaltes
		?>
