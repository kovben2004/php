...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 14. Mrz 2023 um 12:03
...
INSERT INTO `tbl_telnos` (`IDTelno`, `FIDUser`, `Telno`) VALUES
(1, 1, '0123 4567890'),
(2, 10, '0234 5967495'),
(3, 1, '0795 482376843'),
(4, 8, '0485 293234'),
(5, 1, '03496 2346834'),
(6, 10, '08376 873248723'),
(7, 18, '08374 235432'),
(8, 7, '03654 2375763'),
(9, 16, '035 883475');
...
--
ALTER TABLE `tbl_geschlechter`
  MODIFY `IDGeschlecht` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tbl_telnos`
  MODIFY `IDTelno` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
